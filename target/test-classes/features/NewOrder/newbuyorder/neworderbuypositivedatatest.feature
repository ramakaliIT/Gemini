...
Feature:Users should be able to place buy orders with valid credentials
  admins new buy order, new buy margin order and traders only new buy order
  ...
  Scenario Outline:TC_00001_As an admin, i must be able to place a buy order  with valid credentials
    ...
    Examples:
      ...
      | apikey | btcusd |   0    |          | 17     | 8          | 13650 | buy  | exchange limit | immediate-or-cancel | primary     | apisecret | 200        |
      | apikey | btcusd |    0   |          | 13     | 5          | 13650 | buy  | exchange limit |                     | primary     | apisecret | 200        |
